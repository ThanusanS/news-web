    ...
    <>
      ...
      <Layout>
        <div className="max-w-2xl mx-auto px-4 py-24 text-center">
          ...
          <p className="text-xl text-stone-600 dark:text-neutral-400 mb-2">Page Not Found</p>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <Link href="/search" className="btn-secondary px-6 py-2.5">Search Articles</Link>
          </div>
        </div>
      </Layout>
    </>
