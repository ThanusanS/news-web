...
export default function PrivacyPage() {
  ...
  return (
    <>
      <NextSeo
        title="Privacy Policy | CeylonUpdates.me"
        description="Read the CeylonUpdates.me Privacy Policy, including data collection, cookies, analytics, and Google AdSense advertising disclosures."
        canonical="https://www.ceylonupdates.me/privacy"
      />
        ...
        <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
          ...
          <div className="mt-8 space-y-8 text-sm leading-relaxed text-stone-700 dark:text-neutral-300">
            <section>
              ...
              <p className="mt-2">
                CeylonUpdates.me respects your privacy. This Privacy Policy explains what
                information we collect, how we use it, and your choices regarding your personal
                data.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5">
                ...
                <li>
                  Technical data such as browser type, device details, IP address, and referral
                  pages.
                </li>
            ...
            <section>
              ...
              <p className="mt-2">
                We use cookies and similar technologies to keep the site functional, analyze usage,
                and support advertising. Cookies may be set by us and by trusted third-party
                services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                We use Google AdSense to serve ads. Google and its partners may use cookies to
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                help us operate the website, send newsletters, secure the platform, and analyze
                traffic, subject to contractual and legal safeguards.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                and legal obligations. We apply reasonable administrative, technical, and
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                restrict the use of your personal data, and to object to certain processing
                activities.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <a
                  href="mailto:privacy@ceylonupdates.me"
                  className="text-blue-600 hover:underline dark:text-blue-400"
                >
                  privacy@ceylonupdates.me
                </a>
                .
              </p>
            </section>
