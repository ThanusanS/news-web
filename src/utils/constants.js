export const SITE_CONFIG = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://www.ceylonupdates.me',
...
export const CATEGORIES = [
  {
    ...
    iconKey: 'sri-lanka',
    description: 'Latest news from Sri Lanka — politics, economy, sports and culture.',
    color: 'red',
    keywords: ['Sri Lanka news', 'Colombo', 'Ceylon'],
  },
  {
    slug: 'tech-news',
    label: 'Tech News',
    iconKey: 'tech-news',
    description: 'Global technology updates curated for South Asian readers.',
    color: 'blue',
    keywords: ['technology news', 'gadgets', 'startups'],
  },
  {
    slug: 'sports',
    label: 'Sports',
    iconKey: 'sports',
    description: 'Sports highlights, cricket updates and match coverage.',
    color: 'emerald',
    keywords: ['sports news', 'cricket', 'football'],
  },
  {
    slug: 'ai-tutorials',
    label: 'AI & Innovation',
    iconKey: 'ai-tutorials',
    description: 'Learn ChatGPT, Claude, Gemini and the best AI tools.',
    color: 'indigo',
    keywords: ['ChatGPT', 'AI tools', 'machine learning'],
  },
  {
    slug: 'jobs-careers',
    label: 'Jobs & Careers',
    iconKey: 'jobs-careers',
    description: 'Career growth guides, hiring trends and job opportunities.',
    color: 'orange',
  ...
  },
  {
    ...
    label: 'Education',
    iconKey: 'education',
    description: 'Education updates, exams, universities and learning resources.',
    color: 'sky',
    keywords: ['education', 'universities', 'study tips'],
  },
  {
    slug: 'programming',
    label: 'Programming',
    iconKey: 'programming',
    description: 'In-depth tutorials on MERN, Python, React and more.',
    color: 'green',
  ...
  },
  {
    ...
    color: 'purple',
    keywords: ['world news', 'international', 'global'],
  },
  {
    slug: 'business',
    label: 'Business',
    iconKey: 'business',
    description: 'Business news, markets and entrepreneurship.',
    color: 'yellow',
    keywords: ['business', 'economy', 'markets'],
  },
];
...
export function getCategoryLabel(slug = '') {
  return CATEGORY_LABELS[slug] || String(slug).replace(/-/g, ' ');
}
